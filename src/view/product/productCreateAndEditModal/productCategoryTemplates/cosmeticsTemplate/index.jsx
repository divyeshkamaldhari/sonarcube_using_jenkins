    ...
    <>
      ...
      >
        ...
        <Row gutter={16}>
          <Col span={8}>
            <Form.Item
              ...
              rules={[
                { required: true, message: "Please enter water percentage" },
              ]}
            >
              <Input type="number" />
            </Form.Item>
          ...
          <Col span={8}>
            <Form.Item name="origin" label="Cosmetic Origin">
              <Input type="string" />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name="preservativeStatus" label="Contains Preservatives">
              <Input type="string" />
            </Form.Item>
          </Col>
        </Row>
        <Row gutter={16}>
          ...
          <Col span={8}>
            <Form.Item name="Allergens" label="Contains Allergens">
              <Input type="string" />
            </Form.Item>
          </Col>
          <Col span={8}>
